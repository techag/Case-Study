...
const imageSlider = props => {
    return (
        <div className="ImageSlider row">
            <span className="slide-left" onClick={e => props.imageSlideHandler(props.imageIndex, 'left')}>
            ...
            <span className="slide-right" onClick={e => props.imageSlideHandler(props.imageIndex, 'right')}>
